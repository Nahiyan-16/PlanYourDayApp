    ...
    return(
        ...
        shadow-[inset_0_0_15px_5px_rgba(0,0,0,0.5)] xs:w-[100%] sm:w-[50%] md:w-[50%]">
            ...
            <form method="POST" onSubmit={handleLogin}>
                ...
                <Link to="/forgot-password" className="border-none bg-transparent text-charcoal text-opacity-8 text-xs mr-[-98px] no-underline">Forgot Password?
                </Link>
                <div>
                    <button className='text-aliceblue text-xl shadow-[2px_2px_2px_black] transition-all duration-[250ms] m-2.5 px-5 py-2.5 rounded-[10px] border-[none] hover:cursor-pointer hover:shadow-[4px_4px_4px_black] bg-charcoal'>Login</button>
                </div>
